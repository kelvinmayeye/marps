    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            ...
            <ul>
                ...
                @if(View::shared('groupedPermissions') && (isset($groupedPermissions['subject']) || isset($groupedPermissions['classes']) || isset($groupedPermissions['exams']))|| Auth::user()->role->name == 'admin')
                    <li>
                        ...
                        <ul>
                            ...
                            @if(isset($groupedPermissions['exams'])|| Auth::user()->role->name == 'admin')
                                <li class="submenu">
