...
{{--                            </a>--}}
{{--                            <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center">--}}
{{--                                <img class="me-2 rounded-pill" src="{{asset('assets/img/flags/tz.png')}}" alt="Img" height="22" width="22"> Swahili--}}
{{--                            </a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
...
{{--                                <div class="row gx-2">--}}
{{--                                    <div class="col-6">--}}
{{--                                        <a href="" class="d-block bg-primary-transparent ronded p-2 text-center mb-3 class-hover">--}}
...
{{--                                    </div>--}}
{{--                                    <div class="col-6">--}}
{{--                                        <a href="" class="d-block bg-warning-transparent ronded p-2 text-center mb-3 class-hover">--}}
...
{{--                                    </div>--}}
{{--                                    <div class="col-6">--}}
{{--                                        <a href="" class="d-block bg-info-transparent ronded p-2 text-center mb-3 class-hover">--}}
{{--                                            <div class="avatar avatar-lg mb-2">--}}
                        ...
                        <div class="d-block">
                            <div class="d-flex align-items-center p-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-primary mb-0">{{auth()->user()->role->name}}</p>
                                </div>
                            </div>
                            <hr class="m-0">
