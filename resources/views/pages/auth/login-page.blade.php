...
{{--                            <img src="{{asset("assets/img/authentication/coat_of_arms.png")}}" alt="Img">--}}
                            <img src="{{asset("assets/img/authentication/coat_of_arms23.png")}}" alt="Img">
                        </div>
                    </div>
                </div>
                            ...
                            <form action="{{route('login')}}" method="post">
                                ...
                                <div>
                                    <div class=" mx-auto text-center">
                                        <img src="{{asset("assets/img/authentication/municipal-log--o.png")}}" class="img-fluid" alt="Logo">
                                    </div>
                                    <div class="card">
