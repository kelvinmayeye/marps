...
@section('content')
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
            <div class="mb-2">
                <a href="add-student.html" class="btn btn-primary d-flex align-items-center me-3"><i class="ti ti-square-rounded-plus me-2"></i>Add New Student</a>
            </div>
            <div class="mb-2">
                    ...
                    <div class="d-flex align-items-xl-center justify-content-xl-between flex-xl-row flex-column">
                        <div class="mb-3 mb-xl-0">
                            <div class="d-flex align-items-center flex-wrap mb-2">
                                <h1 class="text-white me-2">Welcome Back, Guest User</h1>
            ...
            <div class="card flex-fill">
                ...
                <div class="card-body pb-1">
                    <div class="owl-carousel link-slider">
                        <div class="item">
                            <a href="class-time-table.html" class="d-block bg-success-transparent ronded p-2 text-center mb-3 class-hover">
                            ...
                            <a href="fees-group.html" class="d-block bg-secondary-transparent ronded p-2 text-center mb-3 class-hover">
                        ...
                        <div class="item">
                            <a href="exam-results.html" class="d-block bg-primary-transparent ronded p-2 text-center mb-3 class-hover">
                            ...
                            <a href="class-home-work.html" class="d-block bg-danger-transparent ronded p-2 text-center mb-3 class-hover">
                        ...
                        <div class="item">
                            <a href="student-attendance.html" class="d-block bg-warning-transparent ronded p-2 text-center mb-3 class-hover">
                            ...
                            <a href="attendance-report.html" class="d-block bg-skyblue-transparent ronded p-2 text-center mb-3 class-hover">
